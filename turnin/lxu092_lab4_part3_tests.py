...
tests=[
{'desccription': 'A=0x00,B=0',
    'steps': [ {'inputs': [('PINA', 0x00)],'iterations': 1},],
    'expected': [('PORTB',0x00)]},
{'description': 'A=0x01,B=0',
    'steps': [ {'inputs': [('PINA', 0x01)],'iterations': 1},],
    'expected': [('PORTB',0x00)]},
{'description': 'A=0x02,B=0',
...
{'description': 'A=0x00,B=1',
    'steps': [ {'inputs': [('PINA', 0x00)],'iterations': 1},],
    'expected': [('PORTB',0x01)]},

{'description': 'A=0x80,B=0',
